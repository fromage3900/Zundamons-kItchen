-- [[Script] qTexture (ref: RBX406DAE86DA8247B6A559A8E83FF73BC5)]]
-- Script: qTexture.lua
-- Made by Zeimi
...
local TextureConfiguration = require(script:WaitForChild("TextureConfiguration").Texture.Extras.RigidConstraint.Light.Value)
