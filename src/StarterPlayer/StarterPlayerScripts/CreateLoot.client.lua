...
local icons = {["Money"]= "rbxassetid://6679028840", ["Armor"]= "rbxassetid://6679189765", ["Weapon"]= "rbxassetid://6289027181", 
	["Life"]= "rbxassetid://6475510801", ["Potion"]= "rbxassetid://6679052417", ["Boost"]="rbxassetid://6296361480", 
	["Key"]= "rbxassetid://6679078910", ["Material"]= "rbxassetid://6879525567", ["Consumable"]= "rbxassetid://7197382093", 
...
function CreateNotification(Title,Text,ObjType, image)
	...
	local SetCore = StarterGui:SetCore("SendNotification",{Title = Title, Text = Text, Icon = myicon, Duration = 5})
end
...
function makeLootLocal(myloot, position, generatedCode)
	--print(myloot, position, generatedCode)
