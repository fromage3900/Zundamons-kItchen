...
DecorationConfig.garden_items = {
	...
	},
	{
		...
		meshId      = "rbxassetid://FILL_FountainMesh",
		price       = 120,
		tier        = 2,
		zone        = "garden",
		icon        = "⛲",
...
DecorationConfig.cottage_items = {
	...
	},
	{
		...
		modelName   = "Bookshelf",
		meshId      = "rbxassetid://FILL_BookshelfMesh",
		price       = 50,
		tier        = 1,
		zone        = "cottage",
		icon        = "📚",
	...
	},
	{
		...
		modelName   = "WindowBox",
		meshId      = "rbxassetid://FILL_WindowBoxMesh",
		price       = 35,
		tier        = 1,
		zone        = "cottage",
		icon        = "🌺",
	...
	},
	{
		...
		modelName   = "Fireplace",
		meshId      = "rbxassetid://FILL_FireplaceMesh",
		price       = 150,
		tier        = 2,
		zone        = "cottage",
		icon        = "🔥",
	...
	},
	{
		...
		modelName   = "FancyBed",
		meshId      = "rbxassetid://FILL_FancyBedMesh",
		price       = 180,
		tier        = 2,
		zone        = "cottage",
		icon        = "🛏️",
	...
	},
	{
		...
		meshId      = "rbxassetid://FILL_TrophyShelfMesh",
		price       = 250,
		tier        = 3,
		zone        = "cottage",
		icon        = "🏆",
