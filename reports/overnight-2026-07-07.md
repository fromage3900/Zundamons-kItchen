# Overnight Build Report — 2026-07-07
...
- gather_unique
- cook_quality
- cook_unique_seasonal
- npc_chat_all
- cook_speed
- set_companion

## Not unlocked by milestones
- Edamame Snack (quest-only)
- Fancy Pie (quest-only)
- Zundamon's Banquet (quest-only)
- Sweet Pea Cake (quest-only)
- Pea Flower Tea (quest-only)
- Ultimate Feast (quest-only)
- Zunda Paradise (quest-only)
- Antimon's Speed Soup (quest-only)
- Cardamon's Calm Cup (quest-only)
- Seasonal Salad (quest-only)
- Sakuradamon's Blossom Bites (quest-only)
- Warm Winter Stew (quest-only)
- Ankomon's Protein Punch (quest-only)
- Golden Harvest Platter (quest-only)

## Build
✅ Passed

---
Generated: 2026-07-07T13:49:58.805Z